...
import (
	...
	validate "github.com/wolftotem4/golangloader"
)
...
func RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("len-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("len-items", validate.FieldName(trans, fe.Field()), c)

				default:
					t, err = ut.T("len-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("min-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("min-items", validate.FieldName(trans, fe.Field()), c)

				default:
					t, err = ut.T("min-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("max-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("max-items", validate.FieldName(trans, fe.Field()), c)

				default:
					t, err = ut.T("max-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), validate.FieldName(trans, fe.Field()), fe.Param())
				if err != nil {
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice:
					...
					t, err = ut.T("ne-items", validate.FieldName(trans, fe.Field()), c)
				default:
					t, err = ut.T("ne", validate.FieldName(trans, fe.Field()), fe.Param())
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lt-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lt-items", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("lt-datetime", validate.FieldName(trans, fe.Field()))
				...
				default:
					...
					t, err = ut.T("lt-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lte-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lte-items", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("lte-datetime", validate.FieldName(trans, fe.Field()))
				...
				default:
					...
					t, err = ut.T("lte-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gt-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gt-items", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("gt-datetime", validate.FieldName(trans, fe.Field()))
				...
				default:
					...
					t, err = ut.T("gt-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gte-string", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gte-items", validate.FieldName(trans, fe.Field()), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("gte-datetime", validate.FieldName(trans, fe.Field()))
				...
				default:
					...
					t, err = ut.T("gte-number", validate.FieldName(trans, fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				s, err := ut.T(fe.Tag(), validate.FieldName(trans, fe.Field()), fe.Param())
				if err != nil {
					log.Printf("warning: error translating FieldError: %#v", fe)
					return fe.(error).Error()
				}
...
func translateFunc(ut ut.Translator, fe validator.FieldError) string {
	t, err := ut.T(fe.Tag(), validate.FieldName(ut, fe.Field()))
	if err != nil {
		log.Printf("warning: error translating FieldError: %#v", fe)
		return fe.(error).Error()
	}
