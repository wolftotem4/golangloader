		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("len-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("min-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("max-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lt-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lte-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gt-elements", validate.FieldName(trans, fe.Field()), c)
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gte-elements", validate.FieldName(trans, fe.Field()), c)
